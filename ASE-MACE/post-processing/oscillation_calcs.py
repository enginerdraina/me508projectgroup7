...
# load traj file
trajectory = read('/projectnb/me508/students/krtung/project/ASE/production_nvt_RT.traj', index=":")
...
#max_frame = 20000   # limit to first 20,000 frames
...
plt.title('298K')   # Change for each temp
plt.grid(True)
